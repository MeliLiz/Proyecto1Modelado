...
/**
 * Clase para simular la subcategoria Lacteos de un catalogo
 * @see ComponenteCatalogo
 */
public class Lacteos extends ComponenteCatalogo{
    ...
    public Lacteos(){
        ...
        add(new QuesoPanelaFudi());
        add(new YogurtNaturalAlpuma());
    }
