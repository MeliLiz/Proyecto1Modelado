...
/**
 * Clase para simular la categoria Electrodomestricos de un catalogo
 * @see Categoria
 */
public class Electrodomesticos implements Categoria{
    ...
    public Electrodomesticos(){
        ...
        addProducto(new Microondas());
        addProducto(new Horno());
        addProducto(new Licuadora());
    }
